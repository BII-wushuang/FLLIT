function [] = test_classifiers_L_v2(params,data,weak_learners)
...
%     score_image(reduced_mask==0) = min(score_image(reduced_mask==1));
    ...
    output_result(score_image > thres{i_img},tmp_image,reduced_mask,params.test_subdir_path,[num2str(i_img) '_KB']);
    ...
    save(sav_name,'F','Pre','Rec','Accu','Jaccard_Index','AP','thres','time_tcl');
