function [params,data] = load_data_L_v2(params)
...
for i_op = 1:params.ops_no
    ...
    switch params.dataset_name
        ...
        case 'road'
            ...
            params.opts = init_road;
            
            data.(op).gts.X = load_binary_channel_L_v2(params,op,'gts');
            data.(op).masks.X = load_binary_channel_L_v2(params,op,'masks');
            ...
            case 'imgs'
                ...
                switch params.dataset_name
                    ...
                    case 'road'
                        ...
                        data.(op).(ch).X = load_plain_data_L_v2(params,op,ch);
