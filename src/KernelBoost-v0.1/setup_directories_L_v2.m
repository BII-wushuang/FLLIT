function [params] = setup_directories_L_v2(params)
...
params.dataset_dir = fullfile('results',params.dataset_name);
params.results_dir = fullfile('results',params.dataset_name,params.codename);
